...
module Bitunix
  module WS
    module Futures
      # Shared EventMachine-backed WebSocket client for futures channels.
      #
      ...
      #
      # Subclasses must implement {#ws_uri}. Override {#after_open} for post-connect
      # behavior (e.g. private login).
      class Base
        ...
        def ws_uri
          raise NotImplementedError, "#{self.class}#ws_uri must be implemented"
        end

        # Hook invoked after the socket opens, before draining subscriptions.
        def after_open; end
